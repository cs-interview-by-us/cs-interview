...
- OS
    ...
    - 페이징 & 세그먼테이션 ([PDF](https://github.com/gyoogle/tech-interview-for-developer/blob/master/Computer%20Science/Operating%20System/Paging%20and%20Segmentation.pdf))
    - 페이지 교체 알고리즘
